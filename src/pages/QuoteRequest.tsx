...
import { AddressForm } from "@/components/quote-request/AddressForm";
import { DatePicker } from "@/components/quote-request/DatePicker";
import { EstimationForm } from "@/components/quote-request/EstimationForm";
          ...
          <Card>
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-6">
                ...
                <div ref={estimationSectionRef}>
                  <EstimationForm
                    cartons={cartons}
                    pieces={pieces}
                    volumesSpecifiques={volumesSpecifiques}
                    clientEmail={clientEmail}
                    estimationLoading={estimationLoading}
                    estimationResult={estimationResult}
                    onCartonChange={setCartons}
                    onPiecesChange={setPieces}
                    onVolumesChange={setVolumesSpecifiques}
