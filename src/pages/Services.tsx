...
function SimulateurVolume() {
  // Simple estimation UI (sans calcul réel)
  return (
    <div className="bg-white p-6 rounded-lg border border-demenagement-red shadow-sm mb-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end gap-4">
        <div className="flex flex-col">
          ...
          <input type="number" min="0" placeholder="ex: 15" className="border rounded px-3 py-2 w-32" />
        </div>
        <div className="flex flex-col">
          <label className="font-medium mb-1">Nombre de meubles</label>
          <input type="number" min="0" placeholder="ex: 5" className="border rounded px-3 py-2 w-32" />
        </div>
        <Button className="bg-primary mt-3 md:mt-0" disabled>
